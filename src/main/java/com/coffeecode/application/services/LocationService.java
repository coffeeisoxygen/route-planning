...
public class LocationService {
    ...
    private final LocationPersistancePort locationRepository;
    private final DistanceService distanceService;

    @Autowired
    public LocationService(LocationPersistancePort locationRepository, DistanceService distanceService) {
    ...
    public Optional<Locations> findNearestLocation(double latitude, double longitude) {
        logger.info("Finding nearest location to coordinates: {}, {}", latitude, longitude);
        return locationRepository.findNearestLocation(latitude, longitude);
    }
}
